...
public class InstallSpringBoot40AppIT {
    ...
    public void testThinApplicationExistsInAppsDirectory() throws Exception {
        ...
        File f = new File("target/liberty/wlp/usr/servers/test/apps/thin-springboot-4-appsdirectory-apps-it-1.0.0.Final-exec.jar");
        ...
        try (FileInputStream input = new FileInputStream(configDropinsFile)) {
            ...
            assertEquals("Value of the 1st <springBootApplication/> ==>"+element.getAttribute("location"), "thin-springboot-4-appsdirectory-apps-it-1.0.0.Final-exec.jar", element.getAttribute("location"));
        }
    }
